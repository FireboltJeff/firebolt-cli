...
* Running commands requires an active Firebolt account and a user with privileges to perform operations. For more information, see [Subscribing to Firebolt and creating an account](https://docs.firebolt.io/firebolt-doc-staging/managing-your-account/creating-an-account.html) in Firebolt documentation.
